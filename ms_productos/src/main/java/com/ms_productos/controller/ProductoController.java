package com.ms_productos.controller;
...
import com.ms_productos.impl.ProductoImplement;
...
public class ProductoController {
	...
	@GetMapping("mostrar-todos")//http://localhost:8090/productos/mostrar-todos
	...
	public ResponseEntity<Productos> actualizar(@Valid @RequestBody ProductoRequest req){
		System.out.println("Controller: "+ req.getNombre());
